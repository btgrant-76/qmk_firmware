...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------|
      /*KC_CAPS, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, XXXXXXX,*/___SYM_2_L___,___SYM_2_R___, /*KC_PLUS,  KC_DLR, KC_PERC, KC_CIRC,  KC_DQT, KC_TILD,*/
  ...
  //|--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------|
      /*XXXXXXX, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, RGB_SPI,*/___NUM_2_L___,___NUM_2_R___, /*KC_EQL,    KC_4,    KC_5,    KC_6, KC_QUOT, KC_PENT,*/
  //|--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------|
