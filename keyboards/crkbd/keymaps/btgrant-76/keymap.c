...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                      /*KC_MUTE, KC_MPLY, KC_MSTP,*/___NUM_THUMB_L___, ___NUM_THUMB_R___ /*KC_MINS,    KC_0,  KC_DOT*/
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                          /*XXXXXXX, XXXXXXX, XXXXXXX,*/ ___SYM_THUMB_L___, ___SYM_THUMB_R___ /*KC_UNDS, KC_LPRN, RPRN_TD*/
                                      //`--------------------------'  `--------------------------'
  ),

  [_NAV] = LAYOUT_btgrant_3x6(
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      /*XXXXXXX, TAB_LFT,    BACK,     FWD, TAB_RGT,  UP_DIR,*/ ___NAV_1_L___, ___NAV_1_R___, /*REDO,   PASTE,    COPY,     CUT,    UNDO, XXXXXXX,*/
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          /*DEL_GUI, KC_BSPC,  KC_ENT,*/ ___NAV_THUMB_L___, ___NAV_THUMB_R___ /*XXXXXXX, XXXXXXX, XXXXXXX*/
                                      //`--------------------------'  `--------------------------'
  ),

  [_FUN] = LAYOUT_btgrant_3x6(
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      /*XXXXXXX, XXXXXXX,  UP_DIR,SCRN2CLP, SCRN2FL, XXXXXXX,*/ ___FUN_1_L___, ___FUN_1_R___, /*XXXXXXX,   KC_F7,   KC_F8,   F9_TD,  F12_TD, XXXXXXX,*/
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      /*LOG_OUT, XXXXXXX, DT_PRNT,   DT_UP, DT_DOWN,*/ ___FUN_2_L___, XXXXXXX, ___FUN_2_R___, /*XXXXXXX,   KC_F4,   KC_F5,   F6_TD,  KC_F11, XXXXXXX,*/
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      /*_______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,*/ ___FUN_3_L___, ___FUN_3_R___, /*XXXXXXX,   F1_TD,   F2_TD,   KC_F3,  KC_F10, XXXXXXX,*/
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          /*XXXXXXX,  KC_SPC,  KC_TAB,*/  ___FUN_THUMB_L___, ___FUN_THUMB_R___   /*XXXXXXX, XXXXXXX, XXXXXXX*/
                                      //`--------------------------'  `--------------------------'
  ),
};
